...
> 산출물: `docs/specs/user-stories/index.md`, `docs/specs/user-stories/*.md` (+ 필요시 `docs/specs/PRD.md` 보강).
...
- `docs/specs/user-stories/index.md`, `docs/specs/user-stories/*.md` 초안/갱신.
